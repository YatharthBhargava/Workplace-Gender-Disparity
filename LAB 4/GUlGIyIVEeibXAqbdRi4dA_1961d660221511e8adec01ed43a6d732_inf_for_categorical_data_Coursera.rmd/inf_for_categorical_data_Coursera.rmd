...
inference(y = response, x = year, data = spain, statistic = "proportion", type = "ht", alternative = "twosided", method = "theoretical", success =  "atheist")
```
...
inference(y = response, x = year, data = usa, statistic = "proportion", type = "ht", alternative = "twosided", method = "theoretical", success =  "atheist")
```
